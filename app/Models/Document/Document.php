        ...
        if (isset($global_folder_id)) {
            ...
            if (count($files) > 0) {
                foreach ($files as $file) {
                    $file->link = Utility::getModalLink($file->id, $file->filename, $file->title, $file->original_extension, 0);
                    $file->link_with_icon = Utility::getModalLink($file->id, $file->filename, $file->title, $file->original_extension, 1);
