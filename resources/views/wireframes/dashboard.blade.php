...
<head>
    ...
    <title>FGL HIVE | Dashboard</title>
...
<body class="fixed-navigation">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        @include('wireframes.includes.sidenav')
...
<!--                 <li>
    ...
    <script src="/wireframes/js/plugins/metisMenu/jquery.metisMenu.js"></script>
    <script src="/wireframes/js/plugins/slimscroll/jquery.slimscroll.min.js"></script>

    <!-- Flot -->
    <script src="/wireframes/js/plugins/flot/jquery.flot.js"></script>
    <script src="/wireframes/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
    <script src="/wireframes/js/plugins/flot/jquery.flot.spline.js"></script>
    <script src="/wireframes/js/plugins/flot/jquery.flot.resize.js"></script>
    <script src="/wireframes/js/plugins/flot/jquery.flot.pie.js"></script>
    <script src="/wireframes/js/plugins/flot/jquery.flot.symbol.js"></script>
    <script src="/wireframes/js/plugins/flot/curvedLines.js"></script>

    <!-- Peity -->
    <script src="/wireframes/js/plugins/peity/jquery.peity.min.js"></script>
    <script src="/wireframes/js/demo/peity-demo.js"></script>

    <!-- Custom and plugin javascript -->
    <script src="/wireframes/js/inspinia.js"></script>
    <script src="/wireframes/js/plugins/pace/pace.min.js"></script>

    <!-- jQuery UI -->
    <script src="/wireframes/js/plugins/jquery-ui/jquery-ui.min.js"></script>

    <!-- Jvectormap -->
    <script src="/wireframes/js/plugins/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="/wireframes/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>

    <!-- Sparkline -->
    <script src="/wireframes/js/plugins/sparkline/jquery.sparkline.min.js"></script>

    <!-- Sparkline demo data  -->
    <script src="/wireframes/js/demo/sparkline-demo.js"></script>

    <!-- ChartJS-->
    <script src="/wireframes/js/plugins/chartJs/Chart.min.js"></script>

    <script src="/wireframes/js/plugins/sweetalert/sweetalert.min.js"></script>
