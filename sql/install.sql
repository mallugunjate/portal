...
-- ----------------------------
BEGIN;
INSERT INTO `users` VALUES ('3', 'Brent', 'Garner', 'brent.garner@fglsports.com', '$2y$10$BGSXvZRXl9LCtcscaK288u9WpzzFv3O79lttw6/hDAf3n.y4l3B/m', '1', '', '1', '1', '1', '0000-00-00 00:00:00', 'Q5xHJOhMtJuyp6466sE08gVm29ijKXZabZdlO9ONW7iRyfv0E9NVEYHpAYSm', '0000-00-00 00:00:00', '2016-04-07 15:42:48'), ('4', 'Muhammad', 'Gagan', 'Muhammad.Gagan@fglsports.com', '$2y$10$ssP6iKRQX6SMevNqBaOZFOYkhceWZ2O83Mt0./EeFFClc76yNE.ZW', '2', '', '1', '1', '1', '0000-00-00 00:00:00', null, '2016-05-02 13:13:26', '2016-05-02 13:13:26');
COMMIT;
...
CREATE TABLE `alerts` (
  ...
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `alert_start` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `alert_end` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `bug_reports` (
  ...
  `store_number` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `current_url` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
# Dump of table events_target
# ------------------------------------------------------------

DROP TABLE IF EXISTS `events_target`;
...
CREATE TABLE `events_target` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
  KEY `events_target_event_id_foreign` (`event_id`),
  CONSTRAINT `events_target_event_id_foreign` FOREIGN KEY (`event_id`) REFERENCES `events` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;



# Dump of table urgent_notice_attachment
# ------------------------------------------------------------
...
# Dump of table urgent_notice_target
# ------------------------------------------------------------
